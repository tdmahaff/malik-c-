...
a.Write C11 statements that include the header files iostreamand string.
b.Write a C11 statement that allows you to use cin, cout, and endl
without the prefix std::.
c.Write C11 statements that declareand initialize the following
...
hoursWorkedand wages of type double.
e.Write C11 statements that prompt the user to input two integers
and store the first number in num1and the second number in num2.
f.Write a C11 statement(s) that outputs the values of num1and num2,
indicating which is num1and which is num2.For example, if num1 is
...
the value of the named constant SECRET to it.Then, write a C11 state -
...
j.Write C11 statements that prompt the user to enter a decimal
number between 0 and 70 and then store the number entered into
hoursWorked.
k.Write a C11 statement that multiplies the value of the named con -
stant RATE with the value of hoursWorked and then stores the result
into the variable wages.
l.Write C11 statements that produce the following output :
...
Hours Worked : 45.50
Salary : $568.75
m.Write a C11 program that tests each of the C11 statements that
you wrote in parts a through l.Place the statements at the appropri -
ate place in the C11 program segment given at the beginning of this
...
int main() {
	...
	newNum = num1 * 2 + num2;
	cout << "The value of new number is: " << newNum << endl;
	newNum += SECRET;
	cout << "The value of new number + secret is: " << newNum << endl;
	cout << "Enter a last name: ";
	cin >> name;
	cout << "Enter a decimal number between 0 and 70 for hours worked: ";
	cin >> hoursWorked;
